...
namespace TestFiotec.Migrations
{
    ...
    [Migration("20250325153026_firstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestFiotec.Models.Solicitante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestFiotec.Model.DadosEpidemiologicos", b =>
                {
                    ...
                    b.HasOne("TestFiotec.Models.Solicitante", null)
                        .WithMany("Relatorios")
            ...
            modelBuilder.Entity("TestFiotec.Model.Solicitacao", b =>
                {
                    b.HasOne("TestFiotec.Models.Solicitante", "Solicitante")
                        .WithMany()
                        .HasForeignKey("SolicitanteId")
